...
def load_models():
    try:
        ...
        svm_model_df = joblib.load("svm_model1.joblib")
        lr_model_df = joblib.load("logistic_model1.joblib")
        dnn_model_df = tf.keras.models.load_model("dnn_model1.h5")
        scaler = joblib.load("scaler1.joblib")
        
        # Load models for software defect prediction
        svm_model_sd = joblib.load("svm_model.pkl")
        lr_model_sd = joblib.load("logistic_model.pkl")
        mlp_model_sd = joblib.load("mlp_model.pkl")
